...
class P12(Production):
    ...
    def right_side(iso_ordered_nodes, boundary_map) -> Graph:
        ...
        # x6, y6 = get_middle_node_coords([n1, n2])
        # x7, y7 = get_middle_node_coords([n4, n3]) # upper
        x8, y8 = get_middle_node_coords([n4, n1]) # left
        x9, y9 = get_middle_node_coords([n5, n3]) # right upper
        x10, y10 = get_middle_node_coords([n2, n5]) # right lower
        x11, y11 = get_middle_node_coords([n1, n2, n3, n4, n5]) # center node

        n6.h = False
        n7.h = False
        n8 = Node(x8, y8, "N8", not boundary_map[(n1, n4)]["boundary"])
        ...
        # around
        e1 = HyperEdge((n1, n6), 'E', boundary_map[(n1,n6)]["boundary"], False)
        e2 = HyperEdge((n6, n2), 'E', boundary_map[(n1,n6)]["boundary"], False)
        e3 = HyperEdge((n2, n10), 'E', boundary_map[(n2,n5)]["boundary"], False)
        e4 = HyperEdge((n10, n5), 'E', boundary_map[(n2,n5)]["boundary"], False)
        e5 = HyperEdge((n5, n9), 'E', boundary_map[(n3,n5)]["boundary"], False)
        e6 = HyperEdge((n9, n3), 'E', boundary_map[(n3,n5)]["boundary"], False)
        e7 = HyperEdge((n3, n7), 'E', boundary_map[(n3,n7)]["boundary"], False)
        e8 = HyperEdge((n7, n4), 'E', boundary_map[(n3,n7)]["boundary"], False)
        e9 = HyperEdge((n4, n8), 'E', boundary_map[(n4,n7)]["boundary"], False)
        e10 = HyperEdge((n8, n1), 'E', boundary_map[(n4,n7)]["boundary"], False)
        ...
        # e7 = HyperEdge((n3, n7), 'E', False, False)
        # e8 = HyperEdge((n7, n4), 'E', False, False)
        # e9 = HyperEdge((n4, n8), 'E', False, False)
        # e10 = HyperEdge((n8, n1), 'E', False, False)
